...
//         const blog = new Blog({ name, title, description, image });
//         const createBlog = await blog.save();
//         return NextResponse.json(
//             { message: 'Blog created successfully', success: true, data: createBlog },
//             { status: 201 }
//         );
//     }
//     catch (error) {
...
//         if (error.code === 11000) {
//             return NextResponse.json(
//                 { message: 'Blog with this name already exists', success: false },
//                 { status: 409 }
//             );
//         }
//         return NextResponse.json(
//             { message: 'Failed to create blog', success: false },
//             { status: 500 }
//         );
//     }
// }
